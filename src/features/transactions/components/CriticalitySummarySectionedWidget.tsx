      ...
      {props.projectedRows.map((transaction, index) => {
        ...
        return (
          <tr key={key} className="tt-crit-sectioned-projected-row">
            <td colSpan={2} className="tt-crit-sectioned-projected-cell">
              <div className="tt-crit-sectioned-projected-content">
                <div className="tt-crit-sectioned-projected-title">
                  <strong className="tt-row-title tt-crit-title-ellipsis">{title}</strong>
                  <div className="tt-crit-subline">{formatDate(dateValue)}</div>
                </div>
                <div className="tt-crit-sectioned-projected-amount">
...
export const CriticalitySummarySectionedWidget = (props: {
  account: string
  statementPeriod: string
